...
namespace QLHD_Poctpna
{
    ...
    public class StartUp : StartUpTrans
    {
           ...
           Namespace = "QLHD_Poctpna";
            try
            {
                ...
                if (Editing_Stt_Rec.Equals(string.Empty) && M_CHK_DATE_YN == "1")
                {
                    ...
                    dlgSelTime.LanguageID = "QLHD_PoctpnaSelTime";
        ...
        //static void Post2()
        //{
        //    SqlCommand PostCmd = new SqlCommand("exec [QLHD_Poctpna-Post] @stt_rec");
