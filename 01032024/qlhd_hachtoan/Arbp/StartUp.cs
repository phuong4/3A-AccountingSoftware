...
namespace qlhd_hachtoan
{
    public class StartUp : StartupBase
    {
        ...
        static public string sqlTableName = "qlhd_hachtoan";
        static public string sqlTableView = "v_NN_qlhd_hachtoan";
        static public DataRow CommandInfo;
        static public string SqlTableKey = "ma_ct";
        static public string SqlTableObjectName = "ten_ct";

        static public string TableName = "quản lý hóa đơn";
        static public string TableName_CatDau = "quan ly hoa don";
