...
namespace Dmmauxe
{
    public class StartUp : StartupBase
    {
        ...
        static public string sqlTableName = "dmmauxe";
        static public string sqlTableView = "v_dmmauxe";
        static public DataRow CommandInfo;
        static public string SqlTableKey = "ma_mau";
        static public string SqlTableObjectName = "ten_mau";

        static public string TableName = "màu xe";
        static public string TableName_CatDau = "mau xe";
        ...
        void DoiMa()
        {
            ...
            var tableAndName = new string[] { title, M_LAN.Equals("V") ? "ten_mau" : "ten_mau2" };
