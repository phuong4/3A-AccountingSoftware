...
namespace Dmmauxe
{
    ...
    public partial class newForm : FormList
    {
        ...
        void LoadForm()
        {
            ...
            txtma_mau.MaxLength = ListFunc.GetLengthColumn(TableFields, "ma_mau");
            txtten_mau.MaxLength = ListFunc.GetLengthColumn(TableFields, "ten_mau");
            txtten_mau2.MaxLength = ListFunc.GetLengthColumn(TableFields, "ten_mau");
                        ...
                        try
                        {
                            ...
                            if (StartUp.SysObj.GetOption("M_AUTO_LIST_NUM").ToString().Equals("1"))
                            {
                                if (!string.IsNullOrEmpty(StartUp.currSqlTableKey) && StartUp.SysObj.DmdmInfo.Select("ma_dm like '" + StartUp.sqlTableName + "' and  increase_type = 2").Length > 0)
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(_value) && _value.Length <= txtma_mau.MaxLength)
        ...
        {
            bool result = true;
            if (txtma_mau.Text.Trim() == string.Empty && result == true)
            {
            ...
            if (txtma_mau.Text.Trim() != "" && result == true)
            {
                string sb = SmLib.SysFunc.CheckInValidCode(StartUp.SysObj, txtma_mau.Text.Trim());
                if (sb != "" && result == true)
                {
                    TabInfor.SelectedIndex = 0;
                ...
                if (result == true)
                {
                    try
                    {
                        ...
                        cmdGet.Parameters.Add("@ma_dm", SqlDbType.Char).Value = StartUp.sqlTableName;
                        cmdGet.Parameters.Add("@" + StartUp.SqlTableKey, SqlDbType.Char).Value = txtma_mau.Text.Trim();
                        ...
                        if (result == true && ischeck == true)
                        {
                            ...
                            if (SmLib.SysFunc.CheckStringContain(StartUp.SysObj, StartUp.sqlTableName, StartUp.SqlTableKey, txtma_mau.Text.Trim(), ma_cu))
                            {
                                TabInfor.SelectedIndex = 0;
            ...
            if (txtten_mau.Text.Trim() == string.Empty && result == true)
            {
                TabInfor.SelectedIndex = 0;
        ...
        #region txtma_mau_GotFocus
        private void txtma_mau_GotFocus(object sender, RoutedEventArgs e)
        {
            txtma_mau.Text = txtma_mau.Text.Trim();
            txtma_mau.SelectAll();
        }
        #endregion
