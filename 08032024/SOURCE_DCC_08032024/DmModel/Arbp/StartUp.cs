...
namespace Dmmodel
{
    public class StartUp : StartupBase
    {
        ...
        static public string sqlTableName = "Dmmodel";
        static public string sqlTableView = "v_dmmodel";
        static public DataRow CommandInfo;
        static public string SqlTableKey = "ma_model";
        static public string SqlTableObjectName = "ten_model";

        static public string TableName = "model";
        static public string TableName_CatDau = "model";
        ...
        public override void Run()
        {
           Namespace = "Dmmodel";
            try
            {
                ...
                oBrowse.frmBrw.LanguageID  = "Arbp_1";
                oBrowse.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        void DoiMa()
        {
            ...
            var tableAndName = new string[] { title, M_LAN.Equals("V") ? "ten_model" : "ten_mau2" };
