                ...
                case "FieldCT":
                    {
                        ...
                        {
                            case "ma_kh":
                                return new string[] { FrmCACTBN1.Ma_GD_Value.Text };
                        }
                    }
                    break;
            }
                            ...
                            case "PH":
                                {
                                    switch (paraStr[1].ToString())
                                    {
                                        ...
                                        case "ngay_lct":
                                            ...
                                            break;
                                        case "ma_gd":
                                            //if (FrmCACTBN1.currActionTask == SmDefine.ActionTask.Edit)
                                            //    return true;
                                    ...
                                    if (values[0] != DBNull.Value && values[0] != DependencyProperty.UnsetValue)
                                    {
                                        ...
                                        else if (paraStr[1].Equals("ma_kh2_t"))
                                        {
                                            ...
                                            if (!values[0].Equals(DependencyProperty.UnsetValue))
                                                loai_hd = values[0].ToString();
                                            
                                            string tk_cn = "0";
                                            if (!values[1].Equals(DependencyProperty.UnsetValue))
                                                tk_cn = values[1].ToString();

                                            return !(loai_hd != "0" && tk_cn == "1");
                                        }
                                    }
                                    return false;
                                }
