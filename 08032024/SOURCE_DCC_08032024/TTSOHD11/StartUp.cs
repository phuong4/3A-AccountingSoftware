    ...
    class StartUp : Sm.Windows.Controls.StartupBase
    {
        ...
        public static void CallGridVouchers(object StartDate, object EndDate, string filter, int KindReport)
        {
            try
            {
                ...
                reportHeaderTable.Columns.Add("KHInfo", typeof(String), "TRIM(ten_kh)+' - '+ TRIM(ma_kh)");
                reportHeaderTable.Columns.Add("KHInfo2", typeof(String), "TRIM(ten_kh2)+' - '+ TRIM(ma_kh)");
                ...
                reportHeaderTable.Columns.Add("TCInfo", typeof(decimal), "t_tien2 + t_thue");
                reportHeaderTable.Columns.Add("TCNTInfo", typeof(decimal), "t_tien_nt2 + t_thue_nt");
                reportHeaderTable.Columns.Add("TCInfoCK", typeof(decimal), "t_tien2 + t_thue - t_ck");
                reportHeaderTable.Columns.Add("TCNTInfoCK", typeof(decimal), "t_tien_nt2 + t_thue_nt - t_ck_nt");
                ...
                oBrowse.frmBrw.LanguageID  = "SOHD11_1";
                oBrowse.ShowDialog();
