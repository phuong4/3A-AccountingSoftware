...
namespace AA_POCTPNB
{
    public class StartUp : StartUpTrans
    {
        ...
        static public int M_SD_THUE_DB = 0;
        //Dùng trong form tìm
        static public string tableList = "v_AA_ph72;v_AA_ct72;v_ct72gt";
        ...
        public override void Run()
        {
           Namespace = "AA_POCTPNB";
            try
            {
                ...
                FrmPoctpnb _Form = new FrmPoctpnb();
                ...
                M_SD_THUE_DB = Convert.ToInt16(StartUp.SysObj.GetOption("M_SD_THUE_DB").ToString());
                ...
                if (CommandInfo == null)
                {
                    ExMessageBox.Show( 800,StartUp.SysObj, "Chưa khai báo command hoặc command ngầm định sai!", "", MessageBoxButton.OK, MessageBoxImage.Information);
                    return;
                }
                if (DmctInfo == null)
                {
                    ExMessageBox.Show( 805,StartUp.SysObj, "Chưa khai báo chứng từ hoặc chứng từ ngầm dịnh sai!", "Fast Book 11 .NET", MessageBoxButton.OK, MessageBoxImage.Information);
                    return;
                }    
                ...
                if (Editing_Stt_Rec.Equals(string.Empty) && M_CHK_DATE_YN == "1")
                {
                    ...
                    dlgSelTime.LanguageID = "PoctpnbSelTime";
        ...
        {
            SqlCommand cmd = new SqlCommand("exec [dbo].[POCTPNB-CheckData] @status, @stt_rec");
