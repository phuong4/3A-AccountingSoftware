...
namespace dmkx
{
    public class StartUp : StartupBase
    {
        ...
        static public string sqlTableName = "dmkx";
        static public string sqlTableView = "v_dmkx";
        static public DataRow CommandInfo;
        static public string SqlTableKey = "ma_kx";
        static public string SqlTableObjectName = "ten_kx";

        static public string TableName = "kiểu xe";
        static public string TableName_CatDau = "kieu xe";
        ...
        public override void Run()
        {
           Namespace = "dmkx";
            try
            {
                ...
                oBrowse.frmBrw.LanguageID  = "dmkx_1";
                oBrowse.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        void DoiMa()
        {
            ...
            var tableAndName = new string[] { title, M_LAN.Equals("V") ? "ten_kx" : "ten_kx2" };
