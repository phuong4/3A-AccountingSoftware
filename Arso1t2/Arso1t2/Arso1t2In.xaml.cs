...
namespace Arso1t2
{
    ...
    public partial class Arso1t2In : Sm.Windows.Controls.Form
    {
        ...
        private void Form_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            string[] fields = "ngay_ct,ma_ct0,stt_ct_nkc,so_ct,ct,dien_giai,dien_giai2,ma_kh,ten_kh,ten_kh2,tk_du,ps_no,ps_no_nt,ma_nt,ty_gia,ps_co,ps_co_nt".Split(new char[] { ',' });
